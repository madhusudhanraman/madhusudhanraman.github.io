---
title: "Sarnak and the AlphaZero Test"
...
> outside data or theory, and we input the statement of [some explicit
> and elementary conjecture] and we ask the theorem prover to decide
> if it is true or false. I postulate that it will fail the
> test... That is, the process of generating proofs toward a goal via
...
> statements of great interest to us are true (proven!) but not
...
> theories — “the elementary statistical derivatives of the theories.”
> Indeed, these are the problems that most of us try to solve, most of
> the time. The proving device will expedite the determination and
> understanding of what these are and serve as an assistant in
> resolving them.

This is something David Bessis has argued more persuasively
[elsewhere](https://davidbessis.substack.com/p/the-fall-of-the-theorem-economy). Perhaps
the analogy with chess engines is useful, though.
