...
The Euler-Lagrange equations are equivalent
to to a system of first-order equations known as Hamilton's equations,
which we will now derive. Using the definition of the canonical
momentum, one begins by
...
$ \mathrm{d} q _ {a} $ in \cref{eq:d-hamiltonian,eq:d-hamiltonian-2}
